...
public class EventsPanel extends JPanel {
	...
	*/
	public EventsPanel(DailyItemsPanel _parentPanel, CourseManager courseManager) {
    try {
   ...
   void newEventB_actionPerformed(ActionEvent e) {
    ...
    // Existing method to call the dialog
    newEventB_actionPerformed(e, null, cdate.getTime(), cdate.getTime());
}
...
void newEventB_actionPerformed(ActionEvent e, String tasktext, Date startDate, Date endDate) {
    ...
    // Populate the courseComboBox before showing the dialog
    dlg.courseComboBox.removeAllItems();
    for (Course course : courseManager.getCourses()) {
        dlg.courseComboBox.addItem(course.getCourseName());
    }
