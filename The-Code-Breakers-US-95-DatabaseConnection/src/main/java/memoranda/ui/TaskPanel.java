...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("/ui/icons/todo_remove.png")));
		...
		//UIManager.put("Viewport.background", new ColorUIResource(255, 0, 0));
    ...
    ppRemoveTask.setText(Local.getString("Remove assignment"));
    ...
    ppAddSubTask.setText(Local.getString("Add sub-assignment"));
    ...
    */
    ...
    void editTaskB_actionPerformed(ActionEvent e) {
        ...
        TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("Edit assignment"));
    ...
    void removeTaskB_actionPerformed(ActionEvent e) {
        ...
        int n =
            JOptionPane.showConfirmDialog(
                App.getFrame(),
                msg,
                Local.getString("Remove assignment"),
