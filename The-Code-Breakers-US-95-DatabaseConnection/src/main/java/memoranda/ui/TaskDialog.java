...
//        border7 = BorderFactory.createLineBorder(Color.white, 2);
	...
	// Populate course dropdown from CourseManager
	JComboBox<String> courseDropdown = new JComboBox<>();
        for (String courseName : CourseManager.getAllCourseNames()) {
    courseDropdown.addItem(courseName);
	    ...
	    //new
	JLabel courseLabel = new JLabel(Local.getString("Course"));
        jPanel4.add(courseLabel, null);
        jPanel4.add(courseDropdown, null);
