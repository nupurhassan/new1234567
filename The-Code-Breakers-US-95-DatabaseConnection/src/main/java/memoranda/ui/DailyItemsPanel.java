...
public class DailyItemsPanel extends JPanel {
    ...
    CourseManager courseManager = new CourseManager();  // Initialize CourseManager
    EventsPanel eventsPanel = new EventsPanel(this,courseManager);
    ...
    void jbInit() throws Exception {
        border1 = BorderFactory.createEtchedBorder(Color.black, Color.black);
        border2 = BorderFactory.createEtchedBorder(Color.black, new Color(255, 255, 255));
		...
		//toggleToolBar.setBackground(Color.orange); //for some reason, it works like this but not with preferences...
		toggleToolBar.setOpaque(true);
		toggleToolBar.setVisible(true);
